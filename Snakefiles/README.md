Individual portions of the snakemake pipeline can also be run on their own. See the "Snakefiles/" directory for Snakefiles of each of the following three portion of the pipeline (and their config files):
